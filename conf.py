...
BLOG_AUTHOR = "Model Human Processor"  # (translatable)
BLOG_TITLE = "Model Human Processor"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.modelhumanprocessor.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.modelhumanprocessor.com/"
BLOG_EMAIL = "modelhumanprocessor@protonmail.com"
BLOG_DESCRIPTION = "Personal site of a robot trying to pass as human, tech, culture, news, whatever catches my interest."  # (translatable)
...
GLOBAL_CONTEXT = {}
GLOBAL_CONTEXT['HACK_VARIANT'] = 'dark' #dark, dark-grey, standard, solarized-dark
